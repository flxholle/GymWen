...
public class ExamsActivity extends ActivityFeatures {
    ...
    private void setupAdapter() {
        ...
        adapter = new ExamsAdapter(ExamsActivity.this, listView, R.layout.timetable_listview_exams_adapter, db.getExam());
    ...
    private void setupCustomDialog() {
        final View alertLayout = getLayoutInflater().inflate(R.layout.timetable_dialog_add_exam, null);
